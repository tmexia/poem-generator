...
function generateNewPoem(event) {
  ...
  let prompt = `Please write a poem for children about ${topicInput.value}. Please limit the answer to a 4 line poem and to the poem itself. Please give the answer in basic html paragraphs. Sign the poem with "SheCodes AI", aligned to the right. Be polite. Thank you.`;
